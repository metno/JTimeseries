...
/**
 * A default implementation of the {@link ArrowDataset} interface that stores data
 * values in arrays of double primitives.
 */
public class DefaultArrowDataset extends AbstractXYDataset implements
		ArrowDataset, PublicCloneable {

	private static final long serialVersionUID = 554736122929843216L;

	/** The keys for the series. */
    private List<String> seriesKeys;

    /** Storage for the series data. */
    private List<List<ArrowDataItem>> allSeriesData;
     ...
     * constructor.
     */
	public DefaultArrowDataset() {
		this.seriesKeys = new java.util.ArrayList<String>();
        this.allSeriesData = new java.util.ArrayList<List<ArrowDataItem>>();
	}
     ...
     */
	public DefaultArrowDataset(Object[][][] data) {
     ...
     *     <code>null</code>.
     */
    public DefaultArrowDataset(String[] seriesNames, Object[][][] data) {
     ...
     *     permitted).
     * @param data  the arrow dataset (<code>null</code> not permitted).
     *
     ...
     * @throws NullPointerException if <code>data</code> is <code>null</code>.
     */
	public DefaultArrowDataset(List<String> seriesKeys, Object[][][] data) {
    	if (seriesKeys == null) {
        ...
        this.allSeriesData = new java.util.ArrayList<List<ArrowDataItem>>(seriesCount);

        for (int seriesIndex = 0; seriesIndex < seriesCount; seriesIndex++) {
            List<ArrowDataItem> oneSeriesData = new java.util.ArrayList<ArrowDataItem>();
            ...
            for (int itemIndex = 0; itemIndex < maxItemCount; itemIndex++) {
                ...
                if (xObject != null) {
                    ...
                    Number direction = (Number) data[seriesIndex][itemIndex][1];
                    Number position = (Number) data[seriesIndex][itemIndex][2];
                    Number offset = (Number) data[seriesIndex][itemIndex][3];
                    oneSeriesData.add(new ArrowDataItem(xNumber, direction,position,offset));
                }
            }
     ...
     *
     * @param data  the arrow data (<code>null</code> not permitted).
     *
    ...
    public int getItemCount(int series) {
        ...
        List<ArrowDataItem> oneSeriesData = (List<ArrowDataItem>) this.allSeriesData.get(series);
    ...
    public Number getX(int series, int item) {
        List<ArrowDataItem> oneSeriesData = (List<ArrowDataItem>) this.allSeriesData.get(series);
        ArrowDataItem windItem = (ArrowDataItem) oneSeriesData.get(item);
     ...
     * <code>ArrowDataset</code> is an extension of {@link ArrowDataset}.
     *
     * @param series  the series (zero-based index).
     * @param item  the item (zero-based index).
     *
    ...
    public Number getY(int series, int item) {
        return getDirection(series, item);
    }
     ...
     */
	@Override
	public Number getDirection(int series, int item) {
		List<ArrowDataItem> oneSeriesData = (List<ArrowDataItem>) this.allSeriesData.get(series);
		ArrowDataItem arrowItem = (ArrowDataItem) oneSeriesData.get(item);
        return arrowItem.getDirection();
	}
	...
	public Number getOffset(int series, int item) {
		List<ArrowDataItem> oneSeriesData = (List<ArrowDataItem>) this.allSeriesData.get(series);
		ArrowDataItem arrowItem = (ArrowDataItem) oneSeriesData.get(item);
        return arrowItem.getOffset();
	}
	
	/**
     * Checks this <code>ArrowDataset</code> for equality with an arbitrary
     * object.  This method returns <code>true</code> if and only if:
     * <ul>
     *   <li><code>obj</code> is not <code>null</code>;</li>
     *   <li><code>obj</code> is an instance of
     *       <code>DefaultArrowDataset</code>;</li>
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof DefaultArrowDataset)) {
            return false;
        }
        DefaultArrowDataset that = (DefaultArrowDataset) obj;
