...
/**
 * Filter all items that have a dateFrom that is after the specified fromDate.
 */
public class AfterDateFilter implements ItemFilter {
    ...
    public boolean removeItem(AbstractValueItem nextItem) {
        ...
        if( nextItem.getTimeFrom().after(afterDate) ){
            return true;
        }
        return false;
    }
